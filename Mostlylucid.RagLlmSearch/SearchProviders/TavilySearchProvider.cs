...
public class TavilySearchProvider : ISearchProvider
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var tavilyResponse = await httpResponse.Content.ReadFromJsonAsync<TavilySearchResponse>(cancellationToken);
...
internal class TavilySearchRequest
{
    ...
    [JsonPropertyName("include_answer")] public bool IncludeAnswer { get; set; } = true;

    [JsonPropertyName("include_images")] public bool IncludeImages { get; set; } = false;

    [JsonPropertyName("max_results")] public int MaxResults { get; set; } = 5;
}
...
internal class TavilySearchResponse
{
    ...
    [JsonPropertyName("response_time")] public float ResponseTime { get; set; }
