...
public class BrowserFingerprintData
{
    ...
    public int HasPdfPlugin { get; set; }

    // Headless/automation detection
    [JsonPropertyName("webdriver")]
    public int WebDriver { get; set; }
    ...
    public int ChromeDevTools { get; set; }

    [JsonPropertyName("plugins")]
    public int PluginCount { get; set; }

    [JsonPropertyName("chrome")]
    public bool HasChromeObject { get; set; }

    [JsonPropertyName("permissions")]
    public string? NotificationPermission { get; set; }

    // Window consistency
    [JsonPropertyName("outerW")]
    public int OuterWidth { get; set; }

    [JsonPropertyName("outerH")]
    public int OuterHeight { get; set; }

    [JsonPropertyName("innerW")]
    public int InnerWidth { get; set; }

    [JsonPropertyName("innerH")]
    public int InnerHeight { get; set; }

    // Function integrity
    [JsonPropertyName("evalLen")]
    public int EvalLength { get; set; }

    [JsonPropertyName("bindNative")]
    public int BindIsNative { get; set; }

    // Optional WebGL
    [JsonPropertyName("glVendor")]
    public string? WebGLVendor { get; set; }

    [JsonPropertyName("glRenderer")]
