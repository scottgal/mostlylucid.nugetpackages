...
The remaining build errors are in files we **did not refactor** and represent pre-existing technical debt that requires a separate, systematic API migration effort across the entire codebase.
